...
- Acceptance test table for each functional requirement:
  ...
  - Example:
    ...
    - Comments by User
  - NOTE: You can leave the Actual Test Results blank, any other should be filled. Tester Comments assume the Expected and Actual results more or less the same.
    7.5 Summary
